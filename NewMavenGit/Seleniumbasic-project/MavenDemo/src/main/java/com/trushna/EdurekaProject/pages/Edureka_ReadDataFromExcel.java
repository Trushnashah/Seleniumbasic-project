...
public class Edureka_ReadDataFromExcel {
		static Workbook workbook= null;

	//public static String[][] edureka_readDataFromExcel() throws Exception  {
		public static String[][] edureka_readDataFromExcel(String sheetName)throws Exception{
		...
		//Firstrow's last cell number= last column  
		Row firstrow = sheet.getRow(0);
		int lastCellofFirstRow = firstrow.getLastCellNum();
		...
		String[][] allData = null;
		//if (sheetName=="Login") {
			allData =new String[lastRow+1][lastCellofFirstRow];
		//}else if (sheetName=="Register") {
			//allData =new String[lastRow+1][lastCellofFirstRow];
		//}
